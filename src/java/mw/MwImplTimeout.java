...
public class MwImplTimeout extends Thread{
	...
	int myId;
	boolean trxnstarted=false;

	public MwImplTimeout(Socket client, String rmF, int rmFPort, String rmC,
	...
	public boolean abort() throws IOException
	{
		...
		System.out.println("attempting abort...");
		if(trxnstarted==true && ret != null)
		{
			int size = ret.size();
			boolean ret1= false;
	...
	public boolean reflector(ArrayList<Object> array, DataOutputStream os)
		...
		else if(((String) argument[0]).equals("bogus")) {
			os.writeBoolean(trxnstarted);			
			return true;
		}
