                ...
                synchronized (this.lockTable) 
                {
                    ...
                    if (!bConflict) 
                    {
                        ...
                        if (bConvert.get(0) == true) 
                        {
                            ...
                            // lock table
                        	TrxnObj tempTrxnObj = new TrxnObj(xid, strData, TrxnObj.READ);
                            DataObj tempDataObj = new DataObj(xid, strData, TrxnObj.READ);
                            this.lockTable.remove(tempTrxnObj);
                            this.lockTable.remove(tempDataObj);
